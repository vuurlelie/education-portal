        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProgressPercent = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCourses", x => new { x.UserId, x.CourseId });
                    table.CheckConstraint("CK_UserCourses_Progress_0_100", "[ProgressPercent] BETWEEN 0 AND 100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false),
                    Authors = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BookMaterial_Pages_Pos", "[Pages] > 0");
                    table.CheckConstraint("CK_BookMaterial_Year_Pos", "[PublicationYear] > 0");
                    table.ForeignKey(
                        name: "FK_BookMaterials_BookFormats_FormatId",
                        column: x => x.FormatId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_VideoMaterial_Duration_Pos", "[DurationSec] > 0");
                    table.CheckConstraint("CK_VideoMaterial_Height_Pos", "[HeightPx] > 0");
                    table.CheckConstraint("CK_VideoMaterial_Width_Pos", "[WidthPx]  > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserSkills_Level_Min1", "[Level] >= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookFormats_Name",
                table: "BookFormats",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookMaterials_FormatId",
                table: "BookMaterials",
                column: "FormatId");
