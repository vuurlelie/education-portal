...
namespace EducationPortal.DataAccess.Migrations
{
    ...
    [Migration("20250903153731_Remove_RecordStatus_DbDefaults")]
    partial class Remove_RecordStatus_DbDefaults
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EducationPortal.DataAccess.Entities.UserCourse", b =>
                {
                    ...
                    b.HasOne("EducationPortal.DataAccess.Entities.CourseStatus", "CourseStatus")
                        .WithMany("UserCourses")
